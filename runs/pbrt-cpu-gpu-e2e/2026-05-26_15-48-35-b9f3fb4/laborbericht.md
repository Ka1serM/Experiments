...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_15-48-35-b9f3fb4` |
| Datum/Zeit | `2026-05-26T15:48:35` |
| Scene | `/home/marcel/GitRepositories/Experiments/assets/slanted-edge-target/rossinterpolatedpsf_low.pbrt` |
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_15-48-35-b9f3fb4/rossinterpolatedpsf_low.pbrt` |
| Seed | `1234` |
| SPP | `1` |
...
| CPU vs GPU rel. MSE | `1.885597e-05` | `1.000000e-01` | PASS |
...
| CPU A | CPU | `2.655` |
| CPU B | CPU | `2.658` |
| GPU Durchschnitt | GPU | `0.889` |
| CPU Durchschnitt | CPU | `2.657` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `2.987x` | `198.7%` | `66.5%` |
| A CPU/GPU | `2.620x` | `162.0%` | `61.8%` |
| B CPU/GPU | `3.475x` | `247.5%` | `71.2%` |
