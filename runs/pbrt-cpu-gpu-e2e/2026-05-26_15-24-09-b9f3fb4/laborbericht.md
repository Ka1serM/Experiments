...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_15-24-09-b9f3fb4` |
| Datum/Zeit | `2026-05-26T15:24:09` |
| Scene | `/home/marcel/GitRepositories/Experiments/assets/slanted-edge-target/rossinterpolatedpsf_low.pbrt` |
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_15-24-09-b9f3fb4/rossinterpolatedpsf_low.pbrt` |
| Seed | `1234` |
| SPP | `1` |
...
| CPU vs GPU max rel. pixel error | `9.148952e-01` | — | — |
...
| CPU A | CPU | `2.891` |
| CPU B | CPU | `2.897` |
| GPU Durchschnitt | GPU | `0.893` |
| CPU Durchschnitt | CPU | `2.894` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `3.242x` | `224.2%` | `69.2%` |
| A CPU/GPU | `2.780x` | `178.0%` | `64.0%` |
| B CPU/GPU | `3.885x` | `288.5%` | `74.3%` |
