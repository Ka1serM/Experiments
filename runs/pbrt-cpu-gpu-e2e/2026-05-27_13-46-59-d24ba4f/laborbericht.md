...
| Parameter | Wert |
|---|---|
| Datum/Zeit | `2026-05-27T13:46:59` |
...
|---|---|---|---|---|---|---|---|---|
| CPU A | CPU | `16.912` | `0.000000e+00` | `3.902654e-06` | PASS | PASS | — | — |
| CPU B | CPU | `17.498` | `0.000000e+00` | — | PASS | — | — | — |
| GPU A | GPU | `1.081` | `0.000000e+00` | `3.902654e-06` | PASS | PASS | `15.644x` | `93.6%` |
| GPU B | GPU | `0.868` | `0.000000e+00` | — | PASS | — | `20.161x` | `95.0%` |
| Durchschnitt | CPU/GPU | `17.205` / `0.974` | — | — | — | — | `17.655x` | `94.3%` |
