...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_16-19-23-b9f3fb4` |
| Datum/Zeit | `2026-05-26T16:19:23` |
| Scene | `/home/marcel/GitRepositories/Experiments/assets/slanted-edge-target/rossinterpolatedpsf_low.pbrt` |
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_16-19-23-b9f3fb4/rossinterpolatedpsf_low.pbrt` |
| Seed | `1234` |
| SPP | `1` |
...
| CPU A | CPU | `2.393` |
| CPU B | CPU | `2.402` |
| GPU Durchschnitt | GPU | `0.714` |
| CPU Durchschnitt | CPU | `2.398` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `3.358x` | `235.8%` | `70.2%` |
| A CPU/GPU | `3.547x` | `254.7%` | `71.8%` |
| B CPU/GPU | `3.189x` | `218.9%` | `68.6%` |
