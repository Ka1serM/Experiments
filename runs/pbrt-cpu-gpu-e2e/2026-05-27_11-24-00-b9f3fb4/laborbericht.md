...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-27_11-24-00-b9f3fb4` |
| Datum/Zeit | `2026-05-27T11:24:00` |
...
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-27_11-24-00-b9f3fb4/rossinterpolatedpsf_lg_innotek_31x18.pbrt` |
| Seed | `1234` |
| SPP | `1` |
| PBRT binary | `/home/marcel/GitRepositories/ROSS/build/pbrt-v4/pbrt` |
| PBRT SHA256 | `9e6f8d568e431f8e68a4d85fefa80eb498238ee344954672bbf0b571a8c71936` |
...
| CPU A | CPU | `8.411` |
| CPU B | CPU | `8.434` |
| GPU Durchschnitt | GPU | `0.965` |
| CPU Durchschnitt | CPU | `8.422` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `8.732x` | `773.2%` | `88.5%` |
| A CPU/GPU | `7.856x` | `685.6%` | `87.3%` |
| B CPU/GPU | `9.826x` | `882.6%` | `89.8%` |
