...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-27_13-13-11-b9f3fb4` |
| Datum/Zeit | `2026-05-27T13:13:11` |
...
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-27_13-13-11-b9f3fb4/rossinterpolatedpsf_lg_innotek_31x18.pbrt` |
| Seed | `1234` |
| SPP | `1` |
| PBRT binary | `/home/marcel/GitRepositories/ROSS/build/pbrt-v4/pbrt` |
| PBRT SHA256 | `afa73f5561c2e7165b5302202c68f19b02ec2b3b96a4f5c62874a85eb076a542` |
...
| CPU A | CPU | `14.428` |
| CPU B | CPU | `14.932` |
| GPU Durchschnitt | GPU | `1.000` |
| CPU Durchschnitt | CPU | `14.680` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `14.682x` | `1368.2%` | `93.2%` |
| A CPU/GPU | `12.806x` | `1180.6%` | `92.2%` |
| B CPU/GPU | `17.104x` | `1610.4%` | `94.2%` |
