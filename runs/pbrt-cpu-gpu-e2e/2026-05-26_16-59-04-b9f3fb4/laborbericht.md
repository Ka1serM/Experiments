...
| Parameter | Wert |
|---|---|
| Run directory | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_16-59-04-b9f3fb4` |
| Datum/Zeit | `2026-05-26T16:59:04` |
| Scene | `/home/marcel/GitRepositories/Experiments/assets/slanted-edge-target/rossinterpolatedpsf_low.pbrt` |
| Scene copy | `/home/marcel/GitRepositories/Experiments/runs/pbrt-cpu-gpu-e2e/2026-05-26_16-59-04-b9f3fb4/rossinterpolatedpsf_low.pbrt` |
| Seed | `1234` |
| SPP | `1` |
...
| CPU vs GPU rel. MSE | `1.402506e-05` | `1.000000e-01` | PASS |
| CPU vs CPU max rel. pixel error | `0.000000e+00` | — | — |
| GPU vs GPU max rel. pixel error | `0.000000e+00` | — | — |
| CPU vs GPU max rel. pixel error | `2.979710e-02` | — | — |
...
| CPU A | CPU | `8.177` |
| CPU B | CPU | `8.889` |
| GPU Durchschnitt | GPU | `1.427` |
| CPU Durchschnitt | CPU | `8.533` |

| Vergleich | Multiplikator | Prozent schneller | Zeitersparnis |
|---|---:|---:|---:|
| Durchschnitt CPU/GPU | `5.979x` | `497.9%` | `83.3%` |
| A CPU/GPU | `5.789x` | `478.9%` | `82.7%` |
| B CPU/GPU | `6.165x` | `516.5%` | `83.8%` |
