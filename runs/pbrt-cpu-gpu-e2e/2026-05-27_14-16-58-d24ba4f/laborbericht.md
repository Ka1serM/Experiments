...
| Parameter | Wert |
|---|---|
| Datum/Zeit | `2026-05-27T14:16:58` |
...
|---|---|---|---|---|---|---|---|---|
| CPU A | CPU | `17.522` | `0.000000e+00` | `1.260851e-04` | PASS | PASS | — | — |
| CPU B | CPU | `16.484` | `0.000000e+00` | — | PASS | — | — | — |
| GPU A | GPU | `1.001` | `0.000000e+00` | `1.260851e-04` | PASS | PASS | `17.498x` | `94.3%` |
| GPU B | GPU | `0.859` | `0.000000e+00` | — | PASS | — | `19.199x` | `94.8%` |
| Durchschnitt | CPU/GPU | `17.003` / `0.930` | — | — | — | — | `18.283x` | `94.5%` |
