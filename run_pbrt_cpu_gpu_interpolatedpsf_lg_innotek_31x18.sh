...
echo ""
echo "=== Run end-to-end test with LG Innotek 5mm 31x18 interpolated PSF ==="
"$ross_root/.venv/bin/python" "$script_dir/test_pbrt_cpu_gpu_e2e.py" \
  --scene "$script_dir/assets/scenes/slanted-edge-target/rossinterpolatedpsf_lg_innotek_31x18.pbrt" \
